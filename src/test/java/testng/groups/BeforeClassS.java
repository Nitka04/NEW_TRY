...
public class BeforeClassS {
    WebDriver driver;
//@BeforeClass запуститься один раз перед початком цього классу, прописують якісь несмінні
// речі для тестів.Щоб після кожно тесту не блимало вікно хрома.
    @BeforeClass
    public void start(){
...
//@AfterClass чим завершиться клас.
    @AfterClass
    public void stop(){
        driver.quit();
    }
