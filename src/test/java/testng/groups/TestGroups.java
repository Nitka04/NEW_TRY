...
//groups = {...} ,допомогають хробити розподілення тестів якщо є необхідність запустити
//окрему щруппу тестів яку можна об'єднати за якимось параметром
//можнавдномити тести до декілька групп
